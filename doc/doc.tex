...
\begin{cases}
    ...
    {\color{red}\text{Darcy}} &\text{at } y = 2 \\
    {\color{red}\text{Darcy}} &\text{at } y = 0
    \text{ and } x \in [0, 1]\\
\end{cases}
\] 
...
\subsection{Saturation}
    ...
    \[
    \implies \frac{\rho_1}{\rho_2} = \frac{m_1}{m_2}
    \frac{1 - s}{s}
...
\begin{enumerate}
    ...
    %     in the borders.
    \item Calculate the velocities in the first iteration 
        with a first order scheme. Then, everything is
